...
public class CarsUsersController {
    ...
    public ResponseEntity findCarsUserById(@RequestHeader(value="Authorization") String token, User user){
        ...
        try{
            ...
            return new ResponseEntity(carsUsersService.getCarsUsers(user), HttpStatus.OK) ;
        }catch(Exception e) {
